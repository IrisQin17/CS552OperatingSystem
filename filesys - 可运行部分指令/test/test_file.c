...
int main () {
  ...
  for (i = 0; i < MAX_FILES; i++) { 
    ...
    //printf ("after calling rd_create\n");
    if (retval < 0) {
...
//   printf("WRITE TEST_SINGLE_INDIRECT\n");
...
// #endif // TEST4
  ...
  printf("TEST5 MKDIR dir1 completed\n");
  ...
  printf("TEST5 MKDIR dir2 completed\n");
  ...
  printf("TEST5 MKDIR dir3completed\n");
